...
additionally requires owning the dataset or being an admin. An OAuth token
satisfies any scope by construction, so `malloyyo login` keeps working as it did.
